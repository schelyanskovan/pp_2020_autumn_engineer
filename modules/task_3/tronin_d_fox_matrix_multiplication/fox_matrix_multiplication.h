...
std::vector<double> SequentialMultiplication(const std::vector<double> lhs, const std::vector<double> rhs, size_t n);
std::vector<double> ParallelFoxMultiplication(const std::vector<double> lhs, const std::vector<double> rhs, size_t n);
